...
const Holdings = ( { portfolio, holdings }) => {
    console.log(`Holdings: ${holdings} Portfolio Name: ${portfolio.name}`)
    ...
    <div style={{margin: '25px'}}>
        ...
        {holdings.length === 0 ? (<p className = "text-muted">No holdings yet. Use the Trade tab to buy securities</p>) : 
        (
